  ...
  return (
    <div className="flex flex-col items-center gap-4 lg:pb-24">
      ...
      >
        ...
        >
          <GrProjects className="w-full h-full" />
        </motion.div>
      ...
      <h1 className="text-4xl font-semibold text-white">690</h1>
      <h1 className="text-white text-lg text-center">Projects Completed</h1>
    </div>
  )
}
