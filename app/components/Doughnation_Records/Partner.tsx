  ...
  return (
    <div className="flex flex-col items-center gap-4 lg:pb-24">
      ...
      >
        ...
        >
          <IoIosPeople className="w-full h-full" />
        </motion.div>
      ...
      <h1 className="text-4xl font-semibold text-white">560</h1>
      <h1 className="text-white text-lg text-center min-w-[165px]">Partner Fundings</h1>
    </div>
  )
}
